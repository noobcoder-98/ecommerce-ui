        ...
        <ListItem
          ...
          onClick={() =>
            product.photo !== 'no-photo.jpg'
              ? setCurrentImg(`${process.env.REACT_APP_API}/uploads/${product.photo}`)
...
const dealCounter = (props) => {
  if (props.hot === 'true') {
    return (
      <div
        style={{ borderBottom: '1px solid lightgrey', marginBottom: '3%', paddingBottom: '16px' }}
      >
        <div>
          <span>
            <img
          ...
          <span>
            ...
            {props.timeInMilliSec !== undefined && (
              <span>
                <Countdown date={Date.now() + props.timeInMilliSec} renderer={renderer} />
              </span>
            )}
          </span>
        </div>
        ...
        >
          {!isNaN(props.sold) && (
            <span>
              ...
              {!!props.hot && (
                <WhatshotIcon
                  style={{ color: 'white', fontSize: '1.3em', paddingBottom: '0.2em' }}
                />
              )}
              Sold {props.sold}
            </span>
...
const ProductPriceInfo = ({ product }) => {
  ...
  const discount_price = ((parseFloat(product.price) * parseFloat(product.discount)) / 100).toFixed(
    2
  )
    ...
    if (price > 5) {
      return (
        <Button
          variant="contained"
          color="primary"
          style={{ marginBottom: '1em', marginTop: '1em', fontSize: '0.75em' }}
        >
          {' '}
  ...
  return (
    <div className={classes.block} style={{ border: 'none' }}>
      ...
      {/* rating block */}
      <div
        style={{ borderBottom: '1px solid lightgrey', marginBottom: '1.5em', paddingBottom: '1em' }}
      >
          ...
          <Box component="fieldset" borderColor="transparent">
            ...
            {product.reviews !== undefined && (
              <Link to={'#'} classname={classes.removeLinkStyle}>
                <span style={{ marginLeft: '2em', color: '#46B1FF' }}>
          ...
          <Grid item className="price-block" xl={7} xs={7}>
            <div>
              {discount_price !== 'NaN' ? (
                <>
                  ...
                  <p style={{ color: '#9B9B9B', padding: 0, margin: 0 }}>
                    Saving: <span style={{ color: '#FF3425' }}>{product.discount}%</span> (
                    {discount_price} VND)
                  </p>
              ...
              <div className="add-to-cart">
                ...
                <Grid container xl spacing={2}>
                  <Grid item>
                    <ButtonGroup
                      size="small"
                      style={{ height: '2em', marginTop: '0.4em' }}
                      color={'primary'}
                    >
            ...
            <div className={classes.block} style={{ fontSize: '0.75em', marginTop: '1em' }}>
              ...
              >
                <Grid container>
                  ...
                  <Grid item xs>
                    <span>
                      Please select the shipping location in order to be forecasted a delivery time
                      accurately. <Link to="#">Enter your address.</Link>
                    </span>
                  </Grid>
                </Grid>
              </div>
              <div>
                ...
                <span>
                  <Link to="#">Report the product incorrect information.</Link>
                </span>
              </div>
            </div>
            <div className="promotion-section" style={{ fontSize: '0.75em' }}>
              ...
              <ul>
                <li>
                  <p style={{ padding: 0, margin: 0 }}>
                    Refunds to TikiNow members (maximum: 100k/month),{' '}
                    <span style={{ color: 'red' }}>0.25%</span> (10.375$) -{' '}
                    <Link to="#">Detail</Link>
                  </p>
                </li>
                <li>
                  <span style={{ color: 'red', backgroundColor: 'yellow' }}>SHB card</span> - 10%
                  off for orders from 500k
                </li>
              </ul>
            </div>
          </Grid>
  ...
  const specsArray =
    props.specs !== undefined
      ? props.specs.split(',').map((item, index) => {
          ...
          return (
            <TableRow key={index}>
              <TableCell align="left" style={{ backgroundColor: '#F4F4F4', fontWeight: 600 }}>
                {item[0]}
              </TableCell>
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ marginLeft: '2em', marginRight: '2em', marginTop: '2em', width: '95%' }}
      >
      ...
      <div style={{ marginLeft: '2em', marginRight: '2em', marginTop: '2em' }}>
        ...
        <div className={classes.grid} style={{ backgroundColor: 'white', padding: '2%' }}>
          {product.description}
        </div>
      </div>
    </div>
      ...
      <div className={classes.grid} style={{ padding: '2em' }}>
        ...
        <div style={{ display: 'inline-block' }}>
          ...
          <div className={classes.answer}>
            Tiki answered at: {Moment(Date.now()).format('MMMM DD,YYYY')}
          </div>
        </div>
      </div>
    </div>
        ...
        <div>
          <Grid container style={{ padding: '1em' }}>
            ...
            <Grid item xs={8} style={{ textAlign: 'left', marginLeft: '2em' }}>
              ...
              <p style={{ color: '#22B345', fontSize: '0.75em' }}>Bought from Tiki</p>
        ...
        <div style={{ padding: '2%', margin: 0 }}>
          <Grid container wrap="nowrap" style={{ textAlign: 'center' }}>
            <Grid item xs={3}>
              ...
              >
                <Rating name="read-only" value={product.averageRating || 0} readOnly />
              </Box>
            </Grid>
            <Grid item xs={6}>
        ...
        <Grid container className={classes.grid} style={{ margin: 0, marginTop: '2em' }}>
          ...
          <Grid item xs={7}>
            <div style={{ marginLeft: '0.5em', borderLeft: '2px solid #F7F7F7', padding: '3%' }}>
              {product !== null && product !== undefined && <ProductPriceInfo product={product} />}
            </div>
          </Grid>
        </Grid>

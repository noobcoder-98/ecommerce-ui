...
const NavBar = (props) => {
  ...
  useEffect(() => {
    ...
    props.checkIsAdmin !== undefined &&
      props.checkIsAdmin &&
      message.error('you to be logged in as an admin to access this route')
  }, [])
    ...
    >
      ...
      <MenuItem onClick={handleOpenModal}>
        <IconButton aria-label="Log In" color="inherit" className={classes.iconNav}>
          <Icon className={'fas fa-user'} style={{ paddingTop: '0.05em' }} />
        </IconButton>
        <p>Login</p>
      </MenuItem>
    </Menu>
    ...
    >
      ...
      >
        <Button
          ...
          style={{ color: 'black', width: '100%', backgroundColor: '#D5D5D5' }}
        >
          <img src={Tikinow2} alt="ticketBox" style={{ width: '10%', marginRight: '1em' }} />{' '}
          <span>Tiki Now</span>
        </Button>
      </Link>
    ...
    >
      ...
      <Typography className={classes.title} variant="subtitle2" noWrap component={'p'}>
        ...
        <IconButton
          ...
          style={{ padding: 0 }}
        >
          <Icon className={'fas fa-angle-down'} style={{ fontSize: 14, width: '1.5em' }} />
        </IconButton>
      </Typography>
    </Toolbar>
  )
    ...
    >
          ...
          >
            <i
              style={{
                ...
                height: '33px',
                filter:
                  'opacity(0.5) drop-shadow(0 0 0 white) drop-shadow(0 0 0 white) drop-shadow(0 0 0 white)',
              }}
            />
          </IconButton>
      ...
      <div className={classes.search} id={'autocomContainer'}>
        <div
          ...
          onClick={() => search.length > 0 && props.history.push(`/product/${search}`)}
        >
          <SearchIcon />
        </div>
      ...
      <div className={classes.sectionDesktop2}>
        ...
        <Typography component={'div'}>
          <Link
            ...
            className={classes.removeDefaultLink}
          >
            <span style={{ width: '0.2em' }} className={classes.navText}>
              Track{' '}
            </span>
      ...
      >
        <Typography className={classes.title2} noWrap>
          <Link to={'/underDevelopment'} className={classes.removeDefaultLink}>
            ...
            >
              <Icon className={'fas fa-map-marker-alt'} style={{ fontSize: 20, width: '1.5em' }} />
            </IconButton>
        ...
        >
          <IconButton
            ...
            style={{ padding: 0 }}
          >
            <Icon className={'fas fa-angle-down'} style={{ fontSize: 20, width: '1.5em' }} />
          </IconButton>
  ...
  return (
    <section>
      ...
      {/*modal*/}
      <div
        className={classNames(classes.customModal, { [classes.productModal]: productModal })}
        style={{ display: 'none' }}
      >
        <div
        ...
        >
          ...
          <br />
          <br />
          You have not viewed any products. <br /> keep exploring tiki, the product you viewed will
          show up here!
        </div>
      </div>
      {/*Fav Nav*/}
      {position && (
        <Fab
          aria-label="up"
          size={'small'}
          style={{ top: '90%', left: '2%', position: 'fixed', zIndex: 99999 }}

...
const Card = (props) => {
  ...
  const type1 = (
    <Ripples>
      <Link
        to={props.link !== undefined && props.link !== false ? `/${props.slug}/${props.id}` : '#'}
        ...
        >
          <div>
            <img
              ...
              alt="product "
              width={'100%'}
              style={{ borderRadius: '3px', maxHeight: '18em', minHeight: '14em' }}
            />{' '}
            <br />
          </div>
          <div>
            <Grid container style={{ marginBottom: '0.5em' }}>
              <Grid item xs={3} md={4} lg={4} style={{ margin: 0, marginTop: '0.1em' }}>
                <div>
                  <img src={TikiNow} alt="tikinow" width={'70%'} />{' '}
            ...
            {props.discount !== undefined && props.discount > 0 ? (
              <>
                <p style={{ marginBottom: 0 }}>
                  <span style={{ fontWeight: 500 }}>{numberWithCommas(discounted_price)} VND</span>
              ...
              <>
                <p style={{ marginBottom: 0 }}>
                  <span style={{ fontWeight: 500 }}>{numberWithCommas(props.price)} VND</span>
                </p>
              </>
            )}
          </div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <Progress value={!isNaN(props.sold) ? props.sold : 50} className={classes.progress}>
              {!isNaN(props.sold) && (
                <span style={{ zIndex: 9999 }}>
                  ...
                  <span style={{ fontSize: '0.8em' }}>Sold {props.sold}</span>
                </span>
              )}
            </Progress>
        ...
        >
          <div>
            <img
              ...
              alt="product"
              width={'100%'}
              style={{ borderRadius: '3px', maxHeight: '18em', minHeight: '12em' }}
            />{' '}
            <br />
          </div>
          <div>
            {props.count !== undefined && (
              <p style={{ marginBottom: 0, fontWeight: 500, fontSize: '0.8em', color: '#26BC4E' }}>
            ...
            <p>
              ...
              <span style={{ fontWeight: 500, fontSize: '0.8em', color: '#26BC4E' }}>
                Fast delivery 2h
              </span>
            </p>
            <div style={{ marginBottom: '0.2rem' }}>
              <Rating
                ...
                defaultValue={props.rating !== undefined ? props.rating : 3}
                precision={0.5}
                readOnly
                size="small"
            ...
            <Grid item xs container direction="column" spacing={2}>
              <Grid item xs>
                ...
                <Typography variant="body2" gutterBottom>
                  <img src={TikiArrow} className={classes.tikiArrow} alt={'tiki arrow '} /> Ship in
                  2h
                </Typography>
              ...
              <Grid item>
                <Button
                  size="small"
                  color="secondary"
                  onClick={props.deleteItem !== undefined && props.deleteItem}
                >
                  Remove
                </Button>
              ...
              {discounted_price !== 'NaN' ? (
                <>
                  ...
                  <Typography variant="subtitle2">
                    <span className={classes.priceOrigin}>{props.price.toFixed(2)}đ</span>| -
                    {props.discount}%
                  </Typography>
                </>
              ) : (
